...
class EnrichmentAgent:
    ...
    async def _correlate_threat_intelligence(
        ...
        try:
            ...
            if malware_families:
                enrichment_results["intelligence"]["malware_families"] = malware_families
    ...
    async def _get_ip_reputation(self, ip_address: str) -> Optional[Dict[str, Any]]:
    ...
    async def _get_asn_info(self, ip_address: str) -> Optional[Dict[str, Any]]:
    ...
    async def _get_asn_organization(self, asn: str) -> Optional[Dict[str, Any]]:
    ...
    async def _get_asn_reputation(self, asn: str) -> Optional[Dict[str, Any]]:
    ...
    async def _search_malware_associations(self, entity_id: str) -> List[Dict[str, Any]]:
