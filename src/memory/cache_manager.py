...
class CacheManager:
    ...
    def __init__(
        ...
        logger.info(
            f"CacheManager initialized: max_size={max_size}, ttl={default_ttl_seconds}s"
        )
    ...
    def get_or_set(self, key: str, factory_func, ttl_seconds: int | None = None) -> Any:
        """
    ...
    def set_many(self, items: dict[str, Any], ttl_seconds: int | None = None) -> None:
        """
